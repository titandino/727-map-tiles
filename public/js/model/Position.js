...
export const RS_OFFSET_X = 0; // Amount to offset x coordinate to get correct value
export const RS_OFFSET_Y = 7112; // Amount to offset y coordinate to get correct value
